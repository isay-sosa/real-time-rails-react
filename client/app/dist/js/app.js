    ...
    render: function () {
        return (
            React.createElement("div", {className: "articles-container"}, 
                React.createElement(ArticleForm, {onAddArticle: this.addArticle}), 
...
},{"../utils/WebApiUtils":6,"./ArticleForm":2,"./ArticleList":4,"react":162}],2:[function(require,module,exports){
/** @jsx React.DOM */
...
var ArticleForm = React.createClass({displayName: "ArticleForm",
    ...
    render: function () {
        return (
            React.createElement("form", {action: "http://localhost:4000/api/v1/articles", method: "post", className: "article-form", 
                  onSubmit: this.onSubmit}, 
                React.createElement("input", {type: "text", placeholder: "User Name", ref: "articleUser"}), 
                React.createElement("textarea", {cols: "30", rows: "10", placeholder: "Article Content", ref: "articleContent"}), 
                React.createElement("button", {type: "submit"}, "Create Article")
            )
        );
    }
});
...
},{"../utils/WebApiUtils":6,"react":162}],3:[function(require,module,exports){
/** @jsx React.DOM */
    ...
    render: function () {
        return (
            React.createElement("article", {className: "article"}, 
                React.createElement("p", {className: "article-content"}, this.props.content), 
                React.createElement("small", {className: "article-user"}, this.props.user)
            )
        );
    }
});
...
var ArticleList = React.createClass({displayName: "ArticleList",
    ...
    getArticleItems: function () {
        return this.props.articles.map(function (article) {
            return React.createElement(ArticleItem, {key: article.id, content: article.content, user: article.user});
        });
    },
...
},{"./ArticleItem":3,"react":162}],5:[function(require,module,exports){
/** @jsx React.DOM */
...
},{"./components/Article":1,"react":162}],6:[function(require,module,exports){
/**
...
},{"superagent":163}],7:[function(require,module,exports){
